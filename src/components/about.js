    ...
    return (
        <section id="about" className="flex flex-col gap-8 items-center sm:items-start tracking-wide">
          ...
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-3xl hover:text-stone-400 transition duration-200 hover:underline">About Me</h2>
          </div>
          <p className="text-lg sm:text-justify container font-light">
            Hello! 👋
