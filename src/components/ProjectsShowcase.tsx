  ...
  return (
    <section className="mb-12">
      <div className="flex items-center mb-6">
        <FontAwesomeIcon icon={faCode} className="text-blue-500 text-3xl mr-3" />
        <h2 className="text-3xl">Featured Projects</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {featuredProjects.map((project, index) => (
          <div key={index} className="bg-zinc-800 rounded shadow-md overflow-hidden rounded-lg shadow-lg hover:shadow-xl hover:shadow-blue-800/30 transition duration-300">
            <div className="p-6">
