    ...
    return (
        <section id="skills" className="flex flex-col gap-8">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-3xl font-bold hover:text-stone-400 transition duration-200 hover:underline font-italiana">Skills & Abilities</h2>
          </div>
          <ul className="list-disc list-inside space-y-2 container text-md font-italiana font-semibold">
