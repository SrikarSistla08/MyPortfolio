...
function Experience() {
    return (
        <section id="experience" className="flex flex-col gap-8 font-italiana tracking-wide">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-3xl font-Italiana hover:text-stone-400 transition duration-200 hover:underline ">Experience</h2>
          </div>
          <div className="space-y-8 container text lg font-italiana font-semibold">
            <div>
