...
function Experience() {
    return (
        <section id="experience" className="flex flex-col gap-8 font-mono container">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-3xl font-bold hover:text-stone-400 transition duration-200 hover:scale-110 ">Experience</h2>
          </div>
